...
public class PickAndPlaceController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ui != null && ui.IsPlaying && recorder != null)
        {
            ...
            recorder.RecordFrame(
                ...
                heldObject != null,
                heatmap,
                physicalArmJoints,     // 13주차: 관절 속도 기록용
                vel,
                acc
            );
        }
    ...
    public void ResetSimulation()
    {
        ...
        if (heatmap != null)
        {
            heatmap.isHoldingLoad = false;
            // heatmap.loadRigidbody = null;
        }
    ...
    private IEnumerator GraspSequence()
    {
        ...
        if (cube != null)
        {
            ...
            if (heatmap != null)
            {
                heatmap.loadRigidbody = rb;
                heatmap.isHoldingLoad = true;
            }
        }
